...
public class PaymentRequestPaymentData
{
    ...
    [JsonProperty("dynamic_descriptor", NullValueHandling = NullValueHandling.Ignore)] public string DynamicDescriptor { get; set; }
    [JsonProperty("encrypted_data", NullValueHandling = NullValueHandling.Ignore)] public string EncryptedData { get; set; }
    [JsonProperty("generate_token", NullValueHandling = NullValueHandling.Ignore)] public bool GenerateToken { get; set; }
    ...
    [JsonProperty("installments", NullValueHandling = NullValueHandling.Ignore)] public int Installments { get; set; }
    [JsonProperty("note", NullValueHandling = NullValueHandling.Ignore)] public string Note { get; set; }
    [JsonProperty("preauth", NullValueHandling = NullValueHandling.Ignore)] public bool Preauth { get; set; }
