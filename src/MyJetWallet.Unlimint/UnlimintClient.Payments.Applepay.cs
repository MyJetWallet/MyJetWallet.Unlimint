...
namespace MyJetWallet.Unlimint
{
    public partial class UnlimintClient
    {
        ...
        public WebCallResult<PaymentGatewayCreationResponse> CreateGatewayApplepayPayment(
        ...
        public async Task<WebCallResult<PaymentGatewayCreationResponse>> CreateGatewayApplepayPaymentAsync(
            string merchantOrderId,
            string requestId,
            decimal amount,
            string currency,
